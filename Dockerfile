...
RUN echo $URL && \
    ...
    sed -i "s#url = \"https://kubernetes.io\"#url = \"https://v1-25.docs.kubernetes.io\"#" /website/config.toml && \
    sed -i '179 a\[[params.versions]]\nversion = "v1.26"\ngithubbranch = "v1.26.0"\ndocsbranch = "release-1.26"\nurl = "https:\/\/v1-26.docs.kubernetes.io"' /website/config.toml && \
    sed -i '179 a\[[params.versions]]\nversion = "v1.27"\ngithubbranch = "v1.27.0"\ndocsbranch = "release-1.27"\nurl = "https:\/\/v1-27.docs.kubernetes.io"' /website/config.toml && \
